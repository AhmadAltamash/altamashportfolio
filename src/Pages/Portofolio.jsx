...
import { Code, Award, Boxes, ChevronDown } from "lucide-react";
...
const RoundedChevronButton = ({ onClick, isShowingMore }) => (
  <button
    onClick={onClick}
    aria-label={isShowingMore ? "Show fewer projects" : "Show more projects"}
    className="
...
RoundedChevronButton.propTypes = {
  onClick: PropTypes.func.isRequired,
  isShowingMore: PropTypes.bool.isRequired,
};
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[var(--bg-primary)] overflow-hidden" id="Portfolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className="text-[var(--text-secondary)] max-w-2xl mx-auto text-sm md:text-base mt-2">
      ...
      <Box sx={{ width: "100%" }}>
        ...
        <AnimatePresence mode="wait">
          ...
          <TabPanel value={value} index={0} dir={theme.direction}>
            ...
            {projects.length > PROJECTS_INITIAL_COUNT && (
